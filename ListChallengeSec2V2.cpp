	...
	do{
		...
		if(selector == 'q' || selector == 'Q'){
			...
			if(currentSong == playList.end()){
				currentSong = playList.begin();/*Wrapping to begin of the playlist*/
				playCurrentSong(*currentSong);
			}
			playCurrentSong(*currentSong);
		}
			...
			if(currentSong == playList.begin()){
				currentSong = playList.end(); /*Wrapping to end of the playlist*/
			}
			--currentSong;
			playCurrentSong(*currentSong);
		}
